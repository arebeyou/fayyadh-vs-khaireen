...
info.onScore(20, function () {
    ...
    Fayyadh.sayText("Winner Winner Chicken Dinner!", 2000, true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    Khaireen.setPosition(148, 2)
})
let Khaireen: Sprite = null
let Fayyadh: Sprite = null
game.showLongText("When game begins, press the ARROW KEYS to move Fayyadh, Ammar and Abiyyu. If Khaireen catches you, you will lose points! ", DialogLayout.Full)
scene.setBackgroundImage(assets.image`wakanda`)
Fayyadh = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(Fayyadh)
Fayyadh.setStayInScreen(true)
Khaireen = sprites.create(img`
    . f f f . f f f f . f f f . 
    ...
    `, SpriteKind.Enemy)
Khaireen.setPosition(148, 2)
Khaireen.follow(Fayyadh, 70)
let Abiyyu = sprites.create(img`
    . . . . f f f f . . . . . 
    . . f f f f f f f f . . . 
    . f f f f f f c f f f . . 
...
let Ammar = sprites.create(img`
    ...
    . . . . . f f f f f f . . . . . 
    `, SpriteKind.Guard)
controller.moveSprite(Abiyyu, 34, 53)
controller.moveSprite(Ammar, 68, 58)
